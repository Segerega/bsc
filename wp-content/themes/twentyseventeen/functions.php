...
function twentyseventeen_widgets_init() {
    ...
    register_sidebar( array(
        ...
        'id'            => 'social-icons',
        'description'   => __( 'Add widgets here to appear in your menu.', 'twentyseventeen' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
        'before_title'  => '<h2 class="widget-title">',
        'after_title'   => '</h2>',
...
wp_enqueue_style( 'slick-style', get_theme_file_uri( '/assets/js/slick/slick.css' ), array(), null);
wp_enqueue_style( 'slick-custom-style', get_theme_file_uri( '/assets/js/slick/custom.css' ), array(), null);
wp_enqueue_script( 'slick', get_theme_file_uri( '/assets/js/slick/slick.js' ), array( 'jquery' ), '1.0', true );
wp_enqueue_script( 'custom', get_theme_file_uri( '/assets/js/custom.js' ), array( 'jquery' ), '1.0', true );
wp_enqueue_script( 'bootstrap', 'https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js', array( 'jquery' ), '1.0', true );
